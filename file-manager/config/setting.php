...
$config['settingSystemDefault'] = array(
	...
	'systemName'		=> "File Manager",
	'systemDesc'		=> "File Manager",
...
$config['settingDefault'] = array(
	...
	'soundOpen'			=> "0",			// 操作音效
	'theme'				=> "modern",	// app theme [modern,mac,win7,win10,metro,metro_green,alpha]
	'wall'				=> "8",			// wall picture
...
$config['settingAll'] = array(
	...
	'themeall'		=> "modern,mac,win10,win7,metro,metro_green,metro_purple,metro_pink,metro_orange,alpha_image,alpha_image_sun,alpha_image_sky,diy",
